		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                                                 \
		  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) }, /* DeviceTypeList                                            \
			...
			{ ZAP_SIMPLE_DEFAULT(5), 0x0000001C, 1, ZAP_TYPE(INT8U),                                       \
			  0 }, /* NumberOfCredentialsSupportedPerUser                                                  \
				*/                                                                                     \
			{ ZAP_SIMPLE_DEFAULT(0), 0x00000023, 4, ZAP_TYPE(INT32U),                                      \
			  ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* AutoRelockTime */                                         \
			...
			{ ZAP_SIMPLE_DEFAULT(0x187), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */          \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 14, 116 }, { ZAP_CLUSTER_INDEX(14), 3, 45 },                                   \
	}

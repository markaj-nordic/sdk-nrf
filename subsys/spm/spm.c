...
#define NON_SECURE_APP_ADDRESS FIXED_PARTITION_OFFSET(image_0_nonsecure)
 ...
 */
#if (CONFIG_NRF_DPPI_CHANNEL_MASK_SECURE >= (1 << DPPI_CH_NUM))
#error "CONFIG_NRF_DPPI_CHANNEL_MASK_SECURE exceeds number of available DPPI channels"
#endif
...
static void spm_config_peripherals(void)
{
...
#ifdef NRF_P0
		PERIPH("NRF_P0", NRF_P0, CONFIG_NRF_GPIO0_SECURE),
#endif
#ifdef NRF_CLOCK
		PERIPH("NRF_CLOCK", NRF_CLOCK, CONFIG_NRF_CLOCK_SECURE),
#endif
#ifdef NRF_RTC0
		PERIPH("NRF_RTC0", NRF_RTC0, CONFIG_NRF_RTC0_SECURE),
#endif
#ifdef NRF_RTC1
		PERIPH("NRF_RTC1", NRF_RTC1, CONFIG_NRF_RTC1_SECURE),
#endif
#ifdef NRF_NFCT
		PERIPH("NRF_NFCT", NRF_NFCT, CONFIG_NRF_NFCT_SECURE),
#endif
#ifdef NRF_NVMC
		PERIPH("NRF_NVMC", NRF_NVMC, CONFIG_NRF_NVMC_SECURE),
#endif
#ifdef NRF_UARTE1
		PERIPH("NRF_UARTE1", NRF_UARTE1, CONFIG_NRF_UARTE1_SECURE),
#endif
#ifdef NRF_UARTE2
		PERIPH("NRF_UARTE2", NRF_UARTE2, CONFIG_NRF_UARTE2_SECURE),
#endif
#ifdef NRF_TWIM2
		PERIPH("NRF_TWIM2", NRF_TWIM2, CONFIG_NRF_TWIM2_SECURE),
#endif
#ifdef NRF_SPIM3
		PERIPH("NRF_SPIM3", NRF_SPIM3, CONFIG_NRF_SPIM3_SECURE),
#endif
#ifdef NRF_TIMER0
		PERIPH("NRF_TIMER0", NRF_TIMER0, CONFIG_NRF_TIMER0_SECURE),
#endif
#ifdef NRF_TIMER1
		PERIPH("NRF_TIMER1", NRF_TIMER1, CONFIG_NRF_TIMER1_SECURE),
#endif
#ifdef NRF_TIMER2
		PERIPH("NRF_TIMER2", NRF_TIMER2, CONFIG_NRF_TIMER2_SECURE),
#endif
#ifdef NRF_SAADC
		PERIPH("NRF_SAADC", NRF_SAADC, CONFIG_NRF_SAADC_SECURE),
#endif
#ifdef NRF_PWM0
		PERIPH("NRF_PWM0", NRF_PWM0, CONFIG_NRF_PWM0_SECURE),
#endif
#ifdef NRF_PWM1
		PERIPH("NRF_PWM1", NRF_PWM1, CONFIG_NRF_PWM1_SECURE),
#endif
#ifdef NRF_PWM2
		PERIPH("NRF_PWM2", NRF_PWM2, CONFIG_NRF_PWM2_SECURE),
#endif
#ifdef NRF_PWM3
		PERIPH("NRF_PWM3", NRF_PWM3, CONFIG_NRF_PWM3_SECURE),
#endif
#ifdef NRF_WDT
		PERIPH("NRF_WDT", NRF_WDT, CONFIG_NRF_WDT_SECURE),
#endif
#ifdef NRF_IPC
		PERIPH("NRF_IPC", NRF_IPC, CONFIG_NRF_IPC_SECURE),
#endif
#ifdef NRF_VMC
		PERIPH("NRF_VMC", NRF_VMC, CONFIG_NRF_VMC_SECURE),
#endif
#ifdef NRF_FPU
		PERIPH("NRF_FPU", NRF_FPU, CONFIG_NRF_FPU_SECURE),
#endif
#ifdef NRF_EGU0
		PERIPH("NRF_EGU0", NRF_EGU0, CONFIG_NRF_EGU0_SECURE),
#endif
#ifdef NRF_EGU1
		PERIPH("NRF_EGU1", NRF_EGU1, CONFIG_NRF_EGU1_SECURE),
#endif
#ifdef NRF_EGU2
		PERIPH("NRF_EGU2", NRF_EGU2, CONFIG_NRF_EGU2_SECURE),
#endif
#ifdef NRF_EGU3
		PERIPH("NRF_EGU3", NRF_EGU3, CONFIG_NRF_EGU3_SECURE),
#endif
#ifdef NRF_EGU4
		PERIPH("NRF_EGU4", NRF_EGU4, CONFIG_NRF_EGU4_SECURE),
#endif
#ifdef NRF_EGU5
		PERIPH("NRF_EGU5", NRF_EGU5, CONFIG_NRF_EGU5_SECURE),
#endif
#ifdef NRF_DPPIC
		PERIPH("NRF_DPPIC", NRF_DPPIC, CONFIG_NRF_DPPI_SECURE),
#endif
#ifdef NRF_REGULATORS
		PERIPH("NRF_REGULATORS", NRF_REGULATORS,
				      CONFIG_NRF_REGULATORS_SECURE),
#endif
#ifdef NRF_DCNF
		PERIPH("NRF_DCNF", NRF_DCNF, CONFIG_NRF_DCNF_SECURE),
#endif
#ifdef NRF_CTRLAP
		PERIPH("NRF_CTRLAP", NRF_CTRLAP, CONFIG_NRF_CTRLAP_SECURE),
#endif
#ifdef NRF_SPIM4
		PERIPH("NRF_SPIM4", NRF_SPIM4, CONFIG_NRF_SPIM4_SECURE),
#endif
#ifdef NRF_WDT0
		PERIPH("NRF_WDT0", NRF_WDT0, CONFIG_NRF_WDT0_SECURE),
#endif
#ifdef NRF_WDT1
		PERIPH("NRF_WDT1", NRF_WDT1, CONFIG_NRF_WDT1_SECURE),
#endif
#ifdef NRF_COMP
		PERIPH("NRF_COMP", NRF_COMP, CONFIG_NRF_COMP_SECURE),
#endif
#ifdef NRF_LPCOMP
		PERIPH("NRF_LPCOMP", NRF_LPCOMP, CONFIG_NRF_LPCOMP_SECURE),
#endif
#ifdef NRF_PDM
		PERIPH("NRF_PDM", NRF_PDM, CONFIG_NRF_PDM_SECURE),
#endif
#ifdef NRF_PDM0
		PERIPH("NRF_PDM0", NRF_PDM0, CONFIG_NRF_PDM_SECURE),
#endif
#ifdef NRF_I2S
		PERIPH("NRF_I2S", NRF_I2S, CONFIG_NRF_I2S_SECURE),
#endif
#ifdef NRF_I2S0
		PERIPH("NRF_I2S0", NRF_I2S0, CONFIG_NRF_I2S_SECURE),
#endif
#ifdef NRF_QSPI
		PERIPH("NRF_QSPI", NRF_QSPI, CONFIG_NRF_QSPI_SECURE),
#endif
#ifdef NRF_NFCT
		PERIPH("NRF_NFCT", NRF_NFCT, CONFIG_NRF_NFCT_SECURE),
#endif
#ifdef NRF_MUTEX
		PERIPH("NRF_MUTEX", NRF_MUTEX, CONFIG_NRF_MUTEX_SECURE),
#endif
#ifdef NRF_QDEC0
		PERIPH("NRF_QDEC0", NRF_QDEC0, CONFIG_NRF_QDEC0_SECURE),
#endif
#ifdef NRF_QDEC1
		PERIPH("NRF_QDEC1", NRF_QDEC1, CONFIG_NRF_QDEC1_SECURE),
#endif
#ifdef NRF_USBD
		PERIPH("NRF_USBD", NRF_USBD, CONFIG_NRF_USBD_SECURE),
#endif
#ifdef NRF_USBREGULATOR
		PERIPH("NRF_USBREGULATOR", NRF_USBREGULATOR,
		       CONFIG_NRF_USBREG_SECURE),
#endif
#ifdef NRF_P1
		PERIPH("NRF_P1", NRF_P1, CONFIG_NRF_GPIO1_SECURE),
#endif
#ifdef NRF_OSCILLATORS
		PERIPH("NRF_OSCILLATORS", NRF_OSCILLATORS,
		       CONFIG_NRF_OSCILLATORS_SECURE),
#endif
#ifdef NRF_RESET
		PERIPH("NRF_RESET", NRF_RESET, CONFIG_NRF_RESET_SECURE),
#endif

		/* GPIOTE1 can only be non-secure */
		PERIPH("NRF_GPIOTE1", NRF_GPIOTE1_NS, false),

	};

#if defined(CONFIG_NRF_DPPI_CHANNEL_MASK_SECURE)
	nrf_spu_dppi_config_set(NRF_SPU, 0, CONFIG_NRF_DPPI_CHANNEL_MASK_SECURE, false);
#endif

	PRINT("Peripheral\t\tDomain\t\tStatus\n");

#if defined(CONFIG_NRF_GPIO0_PIN_MASK_SECURE)
	nrf_spu_gpio_config_set(NRF_SPU, 0, CONFIG_NRF_GPIO0_PIN_MASK_SECURE, false);
#endif

#if defined(CONFIG_NRF_GPIO1_PIN_MASK_SECURE)
	nrf_spu_gpio_config_set(NRF_SPU, 1, CONFIG_NRF_GPIO1_PIN_MASK_SECURE, false);
#endif
	...
	for (size_t i = 0; i < ARRAY_SIZE(periph); i++) {
		...
		PRINT("%02u %-21s%s", i, periph[i].name,
		      periph[i].secure ? "Secure\t" : "Non-Secure");
#endif
...
#if defined(CONFIG_ARMV7_M_ARMV8_M_FP) && !defined(CONFIG_NRF_FPU_SECURE)
